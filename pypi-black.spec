...
Source0  : https://files.pythonhosted.org/packages/d8/0d/cc2fb42b8c50d80143221515dd7e4766995bd07c56c9a3ed30baf080b6dc/black-24.10.0.tar.gz
...
%prep
%setup -q -n black-24.10.0
cd %{_builddir}/black-24.10.0
pushd ..
cp -a black-24.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730087508
