...
Source0  : https://files.pythonhosted.org/packages/29/69/f3ab49cdb938b3eecb048fa64f86bdadb1fac26e92c435d287181d543b0a/black-24.2.0.tar.gz
...
%prep
%setup -q -n black-24.2.0
cd %{_builddir}/black-24.2.0
pushd ..
cp -a black-24.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707837661
