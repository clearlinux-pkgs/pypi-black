...
Source0  : https://files.pythonhosted.org/packages/42/58/8a3443a5034685152270f9012a9d196c9f165791ed3f2777307708b15f6c/black-22.1.0.tar.gz
...
%prep
%setup -q -n black-22.1.0
cd %{_builddir}/black-22.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644441335
...
cp %{_builddir}/black-22.1.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-black/edd079e7a759fe1fcf1d089e28b9c7df2080b42c
cp %{_builddir}/black-22.1.0/docs/_static/license.svg %{buildroot}/usr/share/package-licenses/pypi-black/e71d25df55070a88d192a9ecf3a7ad755e44e8ee
cp %{_builddir}/black-22.1.0/src/blib2to3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-black/8482348f12824b36fba59883f9dd7fe03c1f86ca
