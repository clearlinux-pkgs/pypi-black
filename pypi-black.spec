...
Source0  : https://files.pythonhosted.org/packages/2d/e0/8433441b0236b9d795ffbf5750f98144e0378b6e20401ba4d2db30b99a5c/black-23.10.0.tar.gz
...
%prep
%setup -q -n black-23.10.0
cd %{_builddir}/black-23.10.0
pushd ..
cp -a black-23.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697639353
