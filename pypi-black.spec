...
Source0  : https://files.pythonhosted.org/packages/15/11/533355217b1cc4a6df3263048060c1527f733d4720e158de2085293112bb/black-23.1.0.tar.gz
...
%prep
%setup -q -n black-23.1.0
cd %{_builddir}/black-23.1.0
pushd ..
cp -a black-23.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675266865
