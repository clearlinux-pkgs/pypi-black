...
Source0  : https://files.pythonhosted.org/packages/04/b0/46fb0d4e00372f4a86a6f8efa3cb193c9f64863615e39010b1477e010578/black-24.8.0.tar.gz
...
%prep
%setup -q -n black-24.8.0
cd %{_builddir}/black-24.8.0
pushd ..
cp -a black-24.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722632216
