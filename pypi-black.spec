...
Source0  : https://files.pythonhosted.org/packages/8f/5f/bac24a952668c7482cfdb4ebf91ba57a796c9da8829363a772040c1a3312/black-24.3.0.tar.gz
...
%prep
%setup -q -n black-24.3.0
cd %{_builddir}/black-24.3.0
pushd ..
cp -a black-24.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710608665
